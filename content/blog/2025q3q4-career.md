...
其實Ted的協助不僅僅是單純轉職而已，我們幾乎花了一樣多的在討論與探索“我真正想要的職涯規劃”，透過他的經驗，與整個計劃的進行，我也更聚焦我的職涯目標。
...
但相較於網路上的其他前輩，我覺得我在Leetcode的投入相對較少，一部分是因為瞄準公司的是台商居多，而不是Fang等一線外商，另一部分則是我花了更多時間在實際開發專案來獲取實務經驗。
...
技術主管雖然對能源領域不懂，但問的還蠻深入的，整體感覺不錯，但人資面試非常扣分。
...
**Tech Lead**
- 現在的公司是怎樣的公司？產品是什麼？遇到的問題？
- 太陽能管理系統如何運作？接了多少 IoT 設備？數據量？QPS？
- Dashboard 支援多大的時間軸範圍？單日、月、年數據如何呈現？
- 是否有補償缺值的經驗？如何補償？
- 台電的計算方式優化，提升 50 倍速度的細節？
- Pandas 的向量化運算為什麼比較快？原理？
- Backend 服務部署在哪裡？
- 服務是否有監控，如何知道服務是否正常運作？
- 是否發現團隊遇到的問題並解決？
- 如何使用 AI coding 工具提升效率？
- **是否有優化 API 運作速度的經驗？**
- **是否透過調整 DB index 來提升 API 效率？**

**HR**
- 簡單介紹一下履歷
- 為什麼想換工作？
- 如何得知Crescendo？對公司的了解？
- 為什麼對我們有興趣？理想中的工作環境？
- 目前使用什麼 AI 工具？
- 如果現在要離職，交接期大約多久？
- 年薪的期待？
