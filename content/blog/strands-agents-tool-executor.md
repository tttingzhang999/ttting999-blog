...
description: "從 Multi-Agent Chatbot 的實作需求出發，研究 Strands Agents 的 Tool Executor
  如何執行工具，比較同步、非同步與並行方式的行為和效能。"
date: "2026-05-10"
...
- Agent as tool
  ...
  ![strands-agents-tool-executor-agent-loop.png](/images/blog/strands-agents-tool-executor/agent-loop.png)
...
![strands-agents-tool-executor-concurrent-result.png](/images/blog/strands-agents-tool-executor/concurrent-result.png)

## 測試 2: Sequential Executor

![strands-agents-tool-executor-sequential-result.png](/images/blog/strands-agents-tool-executor/sequential-result.png)
