...
export const projects: Project[] = [
  {
    ...
    subtitle: "English Learning Skill for Claude Code",
    screenshot: "/images/projects/promptlingo/demo.png",
    stats: [
      { n: "A1–C2", l: "CEFR levels" },
      { n: "Daily", l: "reports" },
      { n: "0", l: "extra runtime" },
    ],
  },
  {
    ...
    shortName: "EatSwiper",
    kind: "Mobile · iOS",
    subtitle: "Discover Restaurants by Swiping",
    screenshot: "/images/projects/eatswiper/eatswiper_1.png",
    stats: [
      { n: "Live", l: "on App Store" },
      { n: "iOS", l: "shipped 2025" },
      { n: "Offline", l: "favorites" },
    ],
  },
  {
    ...
    shortName: "Moniit",
    kind: "Mobile · Fintech",
    subtitle: "Multi-Asset Management App",
    screenshot: "/images/projects/moniit/moniit_1.png",
    flagship: true,
    stats: [
      { n: "15K+", l: "instruments" },
      { n: "<10s", l: "quote engine" },
      { n: "4", l: "asset classes" },
    ],
  },
  {
    ...
    kind: "Platform · Power grid",
    subtitle: "Charging operations platform",
    stats: [
      { n: "30+", l: "stations" },
      { n: "100+", l: "chargers" },
      { n: "Multi", l: "brand support" },
    ],
  },
  {
    ...
    shortName: "Solar PV",
    kind: "Platform · Power grid",
    subtitle: "Operations & monitoring platform",
    stats: [
      { n: "268MW", l: "capacity" },
      { n: ">95%", l: "detection acc." },
      { n: "−30%", l: "ops cost" },
    ],
  },
  {
    ...
    kind: "Platform · Power grid",
    subtitle: "Wheeling management & simulation",
    stats: [
      { n: "50×", l: "sim speed-up" },
      { n: "4h→1h", l: "fault response" },
      { n: "Cloud Run", l: "cost cut" },
    ],
  },
];
