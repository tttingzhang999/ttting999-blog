...
── Preview: Python 並發處理方法 ──────────────────────────────
  ...
  Canonical: https://ttting999-blog.vercel.app/blog/concurrency
...
── Preview: 2026 Q1 洞察 ───────────────────────────────────
  ...
  Canonical: https://ttting999-blog.vercel.app/blog/2026q1-insights
  ...
...
- 相對路徑 `/images/blog/xxx.png` 自動轉換為 `https://ttting999-blog.vercel.app/images/blog/xxx.png`
- 外部 URL（`https://...`）保持不變
