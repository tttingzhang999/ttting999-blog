export default {
  ...
  home: {
    ...
    about: {
      title: 'About Me',
      description1: 'Hi, I\'m Ting Zhang. I\'ve been working in software for about four years, focused on web applications and cloud infrastructure.',
      description2: 'This site is where I write down the pitfalls I run into while building things, plus the occasional thought from life outside of code.',
